...
class PostAdapter(options: FirestoreRecyclerOptions<Post>,val listener: likeHandle) : FirestoreRecyclerAdapter<Post, PostAdapter.postViewHolder>(
        options
){
class postViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): postViewHolder {
        val viewHolder = postViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.post,parent,false))
